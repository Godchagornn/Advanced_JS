...
function CoursesPage() {
  ...
  function handleSubmit(e) {
    ...
    if (editing) {
      dispatch(updateCourse({ ...payload, id: editing.id }));
      setEditing(null);
    } else {
      dispatch(addCourse({ ...payload, id: Date.now() }));
    }

    setForm({ code: "", title: "", credits: "", dept: "" });
  }
    ...
    <>
      <form onSubmit={handleSubmit} className="add-form glass">
        ...
        <div className="form-row">
          ...
          <input name="dept" placeholder="Dept" value={form.dept} onChange={handleChange} />
